    ...
    <>
      <div className="container mx-auto max-w-[1200px] px-10 py-5 lg:px-0">
        <div className="grid grid-cols-2 gap-4">
          <div className="">
          <input type="text" name="" id="" placeholder="نام شهر را وارد کنید..." className="w-full px-5 py-3 rounded-md"/>
          <div className="flex justify-between mt-10 items-center">
            <div className="flex flex-col gap-5">
              <h1 className="text-5xl font-black">تهران</h1>
              <p>{`احتمال بارش باران : ${0} درصد`}</p>
          ...
          <div className="bg-[#3B3B3B] p-3 rounded-md mt-5">
            ...
            <div className="grid grid-cols-2 mt-5 gap-5 justify-between items-center">
              <div className="flex flex-col gap-3 ">
                ...
                <p className="flex items-start text-right text-3xl">°<span className="text-4xl">30</span></p>
              </div>
